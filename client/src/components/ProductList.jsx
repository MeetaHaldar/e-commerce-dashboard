...
function ProductList() {
  ...
  const getProducts = async () => {
    let result = await fetch("https://e-commerce-dashboard-swart.vercel.app/getProducts", {
      headers: {
  ...
  const deleteProduct = async (id) => {
    let result = await fetch(`https://e-commerce-dashboard-swart.vercel.app/${params.id}`, {
      method: "Delete",
      headers: {
        authorization: JSON.parse(localStorage.getItem('token'))
      }
  ...
  const searchHandle = async (event) => {
    ...
    if (key) {
      let result = await fetch(`https://e-commerce-dashboard-swart.vercel.app/search/${key}`,
        {
          headers: {
            authorization: JSON.parse(localStorage.getItem('token'))
          }
